...
// Reusable Billing view — pure component that takes `slug` as prop, no router
// dependency. Mounted both by /w/:slug/billing (via BillingPage wrapper) AND
// by LandingPage when activeView === 'billing'.
...
export function BillingView({ slug }: { slug: string }) {
